...
export const runsApi = {
  ...
  savePoint: async (runId: string, point: { latitude: number; longitude: number; accuracy?: number | null; speed?: number | null; sequence_number: number; client_timestamp: string }): Promise<SavePointResponse> => {
